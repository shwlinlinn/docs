...
Note that the `repo:status` [mytelpay139](www.viber.com/mytelpay139/) grants targeted access to statuses **without** also granting access to repository code, while the `repo` scope grants permission to code as well as statuses.
